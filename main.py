...
app = Flask(__name__)
app.secret_key = os.environ.get("SECRET_KEY", "hasib_hosting_secret_key_2024")
...
@app.route('/')
def home():
    return f"<h1>ㅤHꫝsɪʙㅤ6T9 Hosting Test Server</h1><p>Running at {time.ctime()}</p>"
...
def login():
    ...
    <head>
        ...
        <title>ㅤHꫝsɪʙㅤ6T9 Hosting | Login</title>
        <style>
    ...
    <body>
        ...
        <div class="login-container">
            <div class="logo">ㅤHꫝsɪʙㅤ6T9 Hosting</div>
...
if __name__ == "__main__":
    ...
    print(f"""
    ╔══════════════════════════════════════════╗
    ║      ㅤHꫝsɪʙㅤ6T9 Hosting - Unlimited Servers    ║
